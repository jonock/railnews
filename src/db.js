...
const defaultSources = [
  ...
  ['Vaunut.org', 'https://vaunut.org/', 'rautatie,juna,junat,veturi,veturit,vaunu,vaunut,asema,radat,rata,raide,liikenne,kalusto,VR,Väylävirasto,Finland,Finnish,Suomi', 1],
